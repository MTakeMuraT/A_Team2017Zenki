...
const float VertexUtil::SQRT2(1.41421356237309504880f);
const float VertexUtil::SQRT3(1.73205080756887729352f);
const float VertexUtil::SQRT6(2.44948974278317809820f);
...
/**************************************************************************
 ...
 戻り値: なし
***************************************************************************/
void VertexUtil::CreateCylinderCap(vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices,
...
/**************************************************************************
 static  void VertexUtil::CreateCube(
	float size,	//1つの辺のサイズ
	vector<VertexPositionNormalTexture>& vertices, //頂点を作成するための配列
	vector<uint16_t>& indices	//インデックスを作成するための配列
 );
...
***************************************************************************/
void VertexUtil::CreateCube(float size,
		 vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices){
	try{
		//Face数は6
...
/**************************************************************************
  static void VertexUtil::CreateSphere(
...
***************************************************************************/
void VertexUtil::CreateSphere(float diameter,size_t tessellation,
		vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices){
	try{
		if (tessellation < 3){
			// 初期化失敗
...
/**************************************************************************
  static void VertexUtil::CreateCapsule(
	float diameter,				//直径サイズ
 ...
 ＊VertexPosNormalTexフォーマットの球体を作成する
***************************************************************************/
void VertexUtil::CreateCapsule(float diameter,
...
/**************************************************************************
  static void VertexUtil::CreateGeoSphere(
	float diameter,	//直径サイズ
	size_t tessellation,	//分割
	vector<VertexPositionNormalTexture>& vertices, //頂点を作成するための配列
	vector<uint16_t>& indices	//インデックスを作成するための配列
...
***************************************************************************/
void VertexUtil::CreateGeoSphere(float diameter, size_t tessellation,
	vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices){
	try{
		...
		{
			return std::make_pair(std::max<uint16_t>(a, b), std::min<uint16_t>(a, b));
		};
...
/**************************************************************************
 static void VertexUtil::CreateCylinder(
	float height,	//高さ
	float diameter,	//直径サイズ
	size_t tessellation,	//分割
	vector<VertexPositionNormalTexture>& vertices,	//頂点を作成するための配列
...
***************************************************************************/
void VertexUtil::CreateCylinder(float height,float diameter,size_t tessellation,
		vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices)
{
	try{
...
/**************************************************************************
 static void VertexUtil::CreateCone(
	float diameter,	//直径サイズ
	float height,	//高さ
...
***************************************************************************/
void VertexUtil::CreateCone(float diameter, float height, size_t tessellation,
		vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices){
	try{
		if (tessellation < 3){
			// 初期化失敗
...
/**************************************************************************
 static void VertexUtil::CreateTorus(
...
***************************************************************************/
void VertexUtil::CreateTorus(float diameter, float thickness, size_t tessellation,
		vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices){
	try{
		if (tessellation < 3){
			// 初期化失敗
...
/**************************************************************************
 static void VertexUtil::CreateTetrahedron(
	float size,		//サイズ
	vector<VertexPositionNormalTexture>& vertices,	//頂点を作成するための配列
	vector<uint16_t>& indices	//インデックスを作成するための配列
	);
...
***************************************************************************/
void VertexUtil::CreateTetrahedron(float size,
		vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices){
	try{
...
/**************************************************************************
 static void VertexUtil::CreateOctahedron(
	float size,	//サイズ
	vector<VertexPositionNormalTexture>& vertices,	//頂点を作成するための配列
	vector<uint16_t>& indices	//インデックスを作成するための配列
	);
...
***************************************************************************/
void VertexUtil::CreateOctahedron(float size,
	vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices){
	try{
...
/**************************************************************************
 static void VertexUtil::CreateDodecahedron(
	float size,	//サイズ
	vector<VertexPositionNormalTexture>& vertices,	//頂点を作成するための配列
	vector<uint16_t>& indices	//インデックスを作成するための配列
	);
...
***************************************************************************/
void VertexUtil::CreateDodecahedron(float size,
		vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices){
	try{
...
/**************************************************************************
 static void VertexUtil::CreateIcosahedron(
	float size,	//サイズ
	vector<VertexPositionNormalTexture>& vertices,	//頂点を作成するための配列
	vector<uint16_t>& indices	//インデックスを作成するための配列
	);
...
***************************************************************************/
void VertexUtil::CreateIcosahedron(float size,
		vector<VertexPositionNormalTexture>& vertices,vector<uint16_t>& indices){
	try{
